...
const (
	// Size of a LSH-512 checksum in bytes.
	Size = 64
	// Size384 of a LSH-384 checksum in bytes.
	Size384 = 48
	// Size256 of a LSH-512-256 checksum in bytes.
	Size256 = 32
	// Size224 of a LSH-512-224 checksum in bytes.
	Size224 = 28

	// BlockSize of LSH-512, LSH-384, LSH-512-256 and LSH-512-224 in bytes.
	BlockSize = 256
)
